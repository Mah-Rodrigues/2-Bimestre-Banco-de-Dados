...
INSERT INTO Livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma) VALUES
('The History of the Decline and Fall of the Roman Empire','Edward Gibbon','1776', TRUE,'História','978-0140437645','Penguin Classics','1232','Inglês')
...
-- Selecionar com COUNT e AVG: Calcule o total e a média de páginas dos livros na categoria "Drama". --        
SELECT COUNT(*) AS total_livros_drama, AVG(paginas) AS media_paginas_drama
FROM livros
...
SELECT MAX(data_publicacao) AS livro_mais_recente, MIN(data_publicacao) AS livro_mais_antigo
FROM livros;
